...
HTTP_TARGETS: dict[str, dict[str, Any]] = {
    ...
    "audit_dashboard": {
        "label": "Dashboard de auditoría LLM",
        "url": "http://audit-dashboard:10700/health",
        "public_port_env": "AUDIT_DASHBOARD_PORT",
        "public_port_default": 10700,
        "public_path": "/",
        "group": "observability",
        "healthy_detail": "Auditoría persistente y dashboard disponibles; autenticación requerida",
    },
    "policy_guard": {
        "label": "Policy Guard",
    ...
    "desktop_gemini": {
        "label": "Escritorio Gemini / noVNC",
        "url": "http://desktop-gemini:6080/vnc.html",
        "public_port_env": "GEMINI_NOVNC_PORT",
        "public_port_default": 6083,
        "public_path": "/vnc.html?autoconnect=1&resize=remote",
        "group": "clients",
        "healthy_detail": "Página noVNC disponible; conexión VNC lista",
    },
